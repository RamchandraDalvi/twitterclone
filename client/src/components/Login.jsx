    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-black text-white">
            <div className="container flex flex-col md:flex-row items-center justify-between px-6 md:px-12 space-y-6 md:space-y-0">
                ...
                {/* Right Section */}
                <form onSubmit={loginHandler} method='POST' className="flex flex-col items-center w-full md:w-[60%] max-w-[400px] space-y-6 p-6 rounded-2xl">
                    ...
                    <button className="w-full py-3 bg-blue-500 hover:bg-blue-400 focus:ring-blue-500 focus:ring-1 text-white font-semibold rounded-full transition duration-200 ease-in-out">
                        Sign in
                    </button>

                    <div className="mt-6 text-center">
                        <p className="text-gray-400">Already have an account?</p>
                        <Link to="/signup" className="text-blue-500 font-semibold hover:underline mt-1">
                            Sign Up
                        </Link>
                    </div>
                </form>
