...
const Chatpage = () => {
    ...
    const { suggestedUsers, selectedUser, user } = useSelector((store) => store.auth);
    ...
    const sendMessage = async (receiverId) => {
        try {
            const res = await axios.post(
                `https://twitterclone-1-g05t.onrender.com/api/v1/message/send/${receiverId}`,
                { textMessage },
                {
        ...
        >
            ...
            >
                 ...
                 <div className={`flex gap-3 items-center px-4 py-3 border-b ${
                        ...
                        <div className="flex flex-col">
                            <span className={`${mode === "dark" ? "text-white" : "text-gray-800"} text-lg font-semibold`}>
                                {user?.username}
                            </span>
                        </div>
                    </div>
                <hr className={`mb-4 ${mode === "dark" ? "border-gray-700" : "border-gray-300"}`} />
                <div className="overflow-y-auto h-[80vh]">
                    {suggestedUsers && suggestedUsers.length > 0 ? (
                        suggestedUsers.map((user) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col">
                                        <span className={`${mode === "dark" ? "text-white" : "text-gray-800"} font-medium`}>
                                            {user?.username}
                                        </span>
                                        <span
                        ...
                        <p className={`${mode === "dark" ? "text-gray-400" : "text-gray-500"} px-3`}>
            ...
            {selectedUser ? (
                ...
                >
                    ...
                    <div className={`flex gap-3 items-center px-4 py-3 border-b ${
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className={`${mode === "dark" ? "text-gray-400" : "text-gray-500"} text-sm`}>
                                online
                            </span>
                        </div>
                    </div>
                    ...
                    <div className={`flex items-center p-4 border-t ${
                        mode === "dark" ? "bg-gray-900 border-gray-700" : "bg-gray-50 border-gray-300"
                    }`}>
                        <input
                            value={textMessage}
                        ...
                        <button
                            ...
                            className={`px-4 py-2 ml-3 rounded-full font-semibold ${
                                mode === "dark"
                ...
                <div className="flex flex-col items-center justify-center mx-auto">
                    ...
                    />
                    <h1 className={`${mode === "dark" ? "text-white" : "text-gray-700"} font-medium text-lg`}>
                        Your messages
                    </h1>
